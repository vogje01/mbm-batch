...
VALUES (UUID(), 'admin', 'admin', 'admin', 'DtIzGPj615i3oxA5xbW+5G5Pf40SrKfCmRDe962SHB5lw9aBR+zdqiylP1Nzt329',
...
VALUES (UUID(), 'admins', 'General admin user group. Cannot be deleted.', 1);
INSERT INTO BATCH_USER_GROUP(ID, NAME, DESCRIPTION, ACTIVE)
VALUES (UUID(), 'users', 'General users group. Cannot be deleted.', 1);
...
VALUES (UUID(), 'Default', 'Default', 'Batch management internal default group. Cannot be deleted.', 1);
INSERT INTO BATCH_JOB_GROUP(ID, NAME, LABEL, DESCRIPTION, ACTIVE)
VALUES (UUID(), 'Performance', 'Performance', 'Batch management internal performance jobs.', 1);
INSERT INTO BATCH_JOB_GROUP(ID, NAME, LABEL, DESCRIPTION, ACTIVE)
VALUES (UUID(), 'Housekeeping', 'Housekeeping', 'Batch management internal housekeeping jobs.', 1);

--
-- Agents
--
INSERT INTO BATCH_AGENT(ID, HOST_NAME, NODE_NAME, STATUS, ACTIVE)
VALUES (UUID(), 'batch-agent-01', 'batch-agent-01', 'UNKNOWN', 1);
INSERT INTO BATCH_AGENT(ID, HOST_NAME, NODE_NAME, STATUS, ACTIVE)
VALUES (UUID(), 'batch-agent-02', 'batch-agent-02', 'UNKNOWN', 1);
INSERT INTO BATCH_AGENT(ID, HOST_NAME, NODE_NAME, STATUS, ACTIVE)
VALUES (UUID(), 'batch-agent-03', 'batch-agent-03', 'UNKNOWN', 1);
INSERT INTO BATCH_AGENT(ID, HOST_NAME, NODE_NAME, STATUS, ACTIVE)
VALUES (UUID(), 'batch-agent-04', 'batch-agent-04', 'UNKNOWN', 1);
INSERT INTO BATCH_AGENT(ID, HOST_NAME, NODE_NAME, STATUS, ACTIVE)
VALUES (UUID(), 'batch-agent-05', 'batch-agent-05', 'UNKNOWN', 1);
INSERT INTO BATCH_AGENT(ID, HOST_NAME, NODE_NAME, STATUS, ACTIVE)
VALUES (UUID(), 'batch-agent-06', 'batch-agent-06', 'UNKNOWN', 1);

--
-- Agent groups
--
INSERT INTO BATCH_AGENT_GROUP(ID, NAME, DESCRIPTION, ACTIVE)
VALUES (UUID(), 'Linux agents', 'All linux agents.', 1);
INSERT INTO BATCH_AGENT_GROUP (ID, NAME, DESCRIPTION, ACTIVE)
VALUES (UUID(), 'Windows agents', 'All windows agents.', 1);
...
VALUES (UUID(), 'housekeeping-batch-windows', 'Housekeeping Batch Windows',
...
VALUES (UUID(), (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'housekeeping-batch-windows'),
...
INSERT INTO BATCH_JOB_DEFINITION(ID, NAME, LABEL, JOB_MAIN_GROUP_ID, DESCRIPTION, TYPE, JOB_VERSION, COMMAND,
                                 FILE_NAME, WORKING_DIRECTORY, LOGGING_DIRECTORY, COMPLETED_EXIT_CODE,
                                 COMPLETED_EXIT_MESSAGE, FAILED_EXIT_CODE, FAILED_EXIT_MESSAGE, ACTIVE)
VALUES (UUID(), 'housekeeping-batch-linux', 'Housekeeping Batch Linux',
...
INSERT INTO BATCH_JOB_DEFINITION_PARAMS(ID, JOB_DEFINITION_ID, KEY_NAME, TYPE, STRING_VAL, DATE_VAL, LONG_VAL,
                                        DOUBLE_VAL, BOOLEAN_VAL, VERSION)
VALUES (UUID(), (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'housekeeping-batch-linux'),
        'houseKeeping.batch.jobExecutionInfo.entityActive', 'BOOLEAN', NULL, NULL, NULL, NULL, 1, 0);
INSERT INTO BATCH_JOB_DEFINITION_PARAMS(ID, JOB_DEFINITION_ID, KEY_NAME, TYPE, STRING_VAL, DATE_VAL, LONG_VAL,
                                        DOUBLE_VAL, BOOLEAN_VAL, VERSION)
VALUES (UUID(), (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'housekeeping-batch-linux'),
...
INSERT INTO BATCH_JOB_DEFINITION(ID, NAME, LABEL, JOB_MAIN_GROUP_ID, DESCRIPTION, TYPE, JOB_VERSION, COMMAND,
                                 FILE_NAME, WORKING_DIRECTORY, LOGGING_DIRECTORY, COMPLETED_EXIT_CODE,
                                 COMPLETED_EXIT_MESSAGE, FAILED_EXIT_CODE, FAILED_EXIT_MESSAGE, ACTIVE)
VALUES (UUID(), 'performance-batch-windows', 'Performance Batch Windows',
...
VALUES (UUID(), 'performance.batch.jobStatus.chunkSize', 'LONG', NULL, NULL, NULL,
        1000, NULL, NULL, (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'performance-batch-windows'));
INSERT INTO BATCH_JOB_DEFINITION_PARAMS (ID, KEY_NAME, TYPE, VALUE, STRING_VAL, DATE_VAL, LONG_VAL, DOUBLE_VAL,
                                         BOOLEAN_VAL, JOB_DEFINITION_ID)
VALUES (UUID(), 'performance.batch.jobCount.chunkSize', 'LONG', NULL, NULL, NULL,
        1000, NULL, NULL, (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'performance-batch-windows'));
INSERT INTO BATCH_JOB_DEFINITION_PARAMS (ID, KEY_NAME, TYPE, VALUE, STRING_VAL, DATE_VAL, LONG_VAL, DOUBLE_VAL,
                                         BOOLEAN_VAL, JOB_DEFINITION_ID)
VALUES (UUID(), 'performance.batch.yearly.chunkSize', 'LONG', NULL, NULL, NULL, 1000,
...
INSERT INTO BATCH_JOB_DEFINITION_PARAMS (ID, KEY_NAME, TYPE, VALUE, STRING_VAL, DATE_VAL, LONG_VAL, DOUBLE_VAL,
                                         BOOLEAN_VAL, JOB_DEFINITION_ID)
VALUES (UUID(), 'performance.batch.weekly.chunkSize', 'LONG', NULL, NULL, NULL, 1000,
        NULL, NULL, (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'performance-batch-windows'));
INSERT INTO BATCH_JOB_DEFINITION_PARAMS (ID, KEY_NAME, TYPE, VALUE, STRING_VAL, DATE_VAL, LONG_VAL, DOUBLE_VAL,
                                         BOOLEAN_VAL, JOB_DEFINITION_ID)
VALUES (UUID(), 'performance.batch.daily.chunkSize', 'LONG', NULL, NULL, NULL, 1000,
        NULL, NULL, (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'performance-batch-windows'));
INSERT INTO BATCH_JOB_DEFINITION_PARAMS (ID, KEY_NAME, TYPE, VALUE, STRING_VAL, DATE_VAL, LONG_VAL, DOUBLE_VAL,
                                         BOOLEAN_VAL, JOB_DEFINITION_ID)
VALUES (UUID(), 'performance.batch.monthly.chunkSize', 'LONG', NULL, NULL, NULL,
        1000, NULL, NULL, (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'performance-batch-windows'));
INSERT INTO BATCH_JOB_DEFINITION_PARAMS (ID, KEY_NAME, TYPE, VALUE, STRING_VAL, DATE_VAL, LONG_VAL, DOUBLE_VAL,
                                         BOOLEAN_VAL, JOB_DEFINITION_ID)
VALUES (UUID(), 'performance.batch.stepCount.chunkSize', 'LONG', NULL, NULL, NULL,
        1000, NULL, NULL, (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'performance-batch-windows'));
-- INSERT INTO BATCH_JOB_SCHEDULE(ID, JOB_DEFINITION_ID, SCHEDULE, NAME, ACTIVE)
-- VALUES (UUID(), (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'performance-batch-windows'), '0 0/15 * * * ?',
...
INSERT INTO BATCH_JOB_DEFINITION(ID, NAME, LABEL, JOB_MAIN_GROUP_ID, DESCRIPTION, TYPE, JOB_VERSION, COMMAND,
                                 FILE_NAME, WORKING_DIRECTORY, LOGGING_DIRECTORY, COMPLETED_EXIT_CODE,
                                 COMPLETED_EXIT_MESSAGE, FAILED_EXIT_CODE, FAILED_EXIT_MESSAGE, ACTIVE)
VALUES (UUID(), 'performance-batch-linux', 'Performance Batch Linux',
...
VALUES (UUID(), 'housekeeping-batch-docker', 'Housekeeping Batch Docker',
        ...
        'batch-jobs-housekeeping-0.0.6-RELEASE.jar', '/app/batch', '/app/batch/log', '0', 'Completed', '-1', 'Failed',
        1);
INSERT INTO BATCH_JOB_DEFINITION_JOB_GROUP(JOB_DEFINITION_ID, JOB_GROUP_ID)
...
INSERT INTO BATCH_JOB_DEFINITION_PARAMS(ID, JOB_DEFINITION_ID, KEY_NAME, TYPE, STRING_VAL, DATE_VAL, LONG_VAL,
                                        DOUBLE_VAL, BOOLEAN_VAL, VERSION)
VALUES (UUID(), (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'housekeeping-batch-docker'),
        'houseKeeping.batch.jobExecutionInfo.entityActive', 'BOOLEAN', NULL, NULL, NULL, NULL, 1, 0);
INSERT INTO BATCH_JOB_DEFINITION_PARAMS(ID, JOB_DEFINITION_ID, KEY_NAME, TYPE, STRING_VAL, DATE_VAL, LONG_VAL,
                                        DOUBLE_VAL, BOOLEAN_VAL, VERSION)
VALUES (UUID(), (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'housekeeping-batch-docker'),
...
VALUES (UUID(), (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'housekeeping-batch-docker'),
        'houseKeeping.batch.stepExecutionInfo.chunkSize', 'LONG', NULL, NULL, 1000, NULL, 1, 0);
INSERT INTO BATCH_JOB_SCHEDULE(ID, JOB_DEFINITION_ID, SCHEDULE, NAME, ACTIVE, VERSION)
VALUES (UUID(), (SELECT ID FROM BATCH_JOB_DEFINITION WHERE NAME = 'housekeeping-batch-docker'), '0 0 1/4 * * ?',
