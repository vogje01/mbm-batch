...
(
    ...
    SCHEDULE_MODE     ENUM ('FIXED', 'RANDOM', 'RANDOM_GROUP', 'MINIMUM_LOAD') DEFAULT 'FIXED',
    SCHEDULE_TYPE     ENUM ('CENTRAL', 'LOCAL')                                DEFAULT 'LOCAL',
...
ALTER TABLE BATCH_PERFORMANCE
    ADD INDEX BATCH_PERFORMANCE_IDX01 (TYPE, TIMESTAMP);
ALTER TABLE BATCH_PERFORMANCE
    ADD INDEX BATCH_PERFORMANCE_IDX02 (QUALIFIER, METRIC, TIMESTAMP);
