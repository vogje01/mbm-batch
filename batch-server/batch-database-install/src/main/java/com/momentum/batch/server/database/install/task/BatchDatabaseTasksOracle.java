 ...
 */
@Component
public class BatchDatabaseTasksOracle {

    private final StringEncryptor stringEncryptor;

    @Autowired
    public BatchDatabaseTasksOracle(StringEncryptor stringEncryptor) {
    ...
    public static void createDatabase(String url, String user, String password) {
        ...
        try {
            ...
            // Open a connection
            conn = DriverManager.getConnection(url, user + " as sysdba", password);
            ...
            stmt.executeUpdate(sql);
            sql = "CREATE USER batchadmin IDENTIFIED BY \"Secret_123\"";
            stmt.executeUpdate(sql);
            sql = "GRANT dba TO batchadmin";
            stmt.executeUpdate(sql);
