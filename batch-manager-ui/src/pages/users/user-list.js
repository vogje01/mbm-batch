...
export default () => {
    ...
    const phonePattern = /^\s*\+[0-9]{2,3}\s*-?\s*\d{3}-?\s*[0-9 ]+$/;
                ...
                <div className={'dx-card responsive-paddings'}>
                    <DataGrid
                        ...
                        <Editing
                            ...
                            allowDeleting={true}>
                            <Form>
                                <SimpleItem itemType="group" colCount={4} colSpan={4} caption={"User Details: " + currentUser.userId}>
                                    ...
                                    <SimpleItem dataField="phone" colSpan={2}>
                                        <PatternRule message="The phone must have a correct phone format" pattern={phonePattern}/>
                                    </SimpleItem>
