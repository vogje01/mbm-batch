...
class PerformanceView extends FisPage {
        ...
        return (
            <React.Fragment>
                <div className="options" style={{overflow: 'hidden'}}>
                    <div className="caption">Selection</div>
                    ...
                    <div className="option" hidden={this.state.customRangeHidden}>
                        ...
                        <DateBox defaultValue={this.now} type="datetime" onValueChanged={this.handleCustomRangeStart} style={{marginRight: '10px'}}/>
