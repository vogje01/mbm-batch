...
import {jobExecutionLogDataSource} from "./JobExecutionDataSource";
import UpdateTimer from "../../components/UpdateTimer";

class JobExecutionLog extends React.Component {

    constructor(props) {
        super(props);
        this.state = {
            currentJobExecutionInfo: this.props.data
        };
    }
        ...
        return (
            <React.Fragment>
                <DataGrid
                    ...
                    dataSource={jobExecutionLogDataSource(this.props.data)}
