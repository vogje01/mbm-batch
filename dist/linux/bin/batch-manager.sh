...
# Java arguments
JAVA_ARGUMENTS="-Dmanager.loggingDirectory=$LOG_DIR -Dlogging.config=file:$LOG_CONFIGURATION -Dspring.config.location=file:$CONFIGURATION -Djasypt.encryptor.password=1Qaz0oKm"
