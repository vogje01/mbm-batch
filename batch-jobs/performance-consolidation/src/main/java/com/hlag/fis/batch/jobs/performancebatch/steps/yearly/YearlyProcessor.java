...
@Component
public class YearlyProcessor implements ItemProcessor<Object[], AgentPerformance> {

    private AgentPerformanceRepository agentPerformanceRepository;

    @Autowired
    public YearlyProcessor(AgentPerformanceRepository agentPerformanceRepository) {
    ...
    public AgentPerformance process(Object[] tuple) {
        ...
        Optional<AgentPerformance> agentPerformanceOptional = agentPerformanceRepository.findByTimestamp((String) tuple[0], AgentPerformanceType.YEARLY, timeStamp);
        AgentPerformance agentPerformance = agentPerformanceOptional.orElseGet(AgentPerformance::new);

        // General data
        agentPerformance.setType(AgentPerformanceType.YEARLY);
