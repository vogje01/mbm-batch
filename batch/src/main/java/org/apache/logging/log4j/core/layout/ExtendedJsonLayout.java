...
public class ExtendedJsonLayout extends AbstractJacksonLayout {
    ...
    public static class Builder<B extends Builder<B>> extends AbstractJacksonLayout.Builder<B>
            implements org.apache.logging.log4j.core.util.Builder<org.apache.logging.log4j.core.layout.ExtendedJsonLayout> {
        ...
        public org.apache.logging.log4j.core.layout.ExtendedJsonLayout build() {
            ...
            return new org.apache.logging.log4j.core.layout.ExtendedJsonLayout(getConfiguration(), locationInfo, properties, encodeThreadContextAsList, isComplete(),
    ...
    static protected ObjectWriter getObjectWriter(boolean encodeThreadContextAsList, boolean includeStacktrace, boolean stacktraceAsString, boolean locationInfo, boolean properties, boolean compact) {
        return new JacksonFactory.JSON(encodeThreadContextAsList, includeStacktrace, stacktraceAsString, true).newWriter(locationInfo, properties, compact);
    }
     ...
     */
    public static org.apache.logging.log4j.core.layout.ExtendedJsonLayout createDefaultLayout() {
        return new org.apache.logging.log4j.core.layout.ExtendedJsonLayout(new DefaultConfiguration(), false, false, false, false, false, false,
    ...
    private ExtendedJsonWrapper convertLog4jEventToExtendedJsonWrapper(LogEvent event) {
        return new ExtendedJsonWrapper(convertMutableToLog4jEvent(event), jsonAdapter.getMixedFields());
    }
